...
export function ItemArt({kind}:{kind:ArtKind}){
 ...
 case 'orchard':case 'farm':art=<><path d="m9 62 45-24 39 24-44 27Z" fill="#b29a76"/>{[25,45,65].map((x,i)=><g key={i} transform={`translate(${x} ${48+i%2*10})`}><path d="M0 20V-7M0 11-9 3M0 2 10-6" stroke="#8f9b60" strokeWidth="3"/><ellipse cx="-7" cy="1" rx="4" ry="9" transform="rotate(-35 -7 1)" fill="#c2c485"/><ellipse cx="8" cy="-8" rx="4" ry="9" transform="rotate(35 8 -8)" fill="#d9d69a"/></g>)}</>;break;
 case 'clayworks':case 'quarry':case 'lumber':art=<><path d="M22 45v35M78 45v35M49 57v31" stroke="#b19670" strokeWidth="6"/><path d="m11 43 41-22 37 23-40 20Z" fill="#c9b18a"/>{[0,13,26].map(n=><g key={n} transform={`translate(27 ${60+n*.45})`}><path d="m0 0 40-9 7 8-40 10Z" fill="#ad8c64"/><ellipse cx="5" cy="5" rx="7" ry="5" fill="#dec69c"/></g>)}</>;break;
